...
public class Optimizer : MonoBehaviour {
	...
	void Start () {
        ...
        experiment.Initialize("Flappy Bird Experiment", xmlConfig.DocumentElement, NUM_INPUTS, NUM_OUTPUTS);

        champFileSavePath = Application.persistentDataPath + string.Format("/{0}.champ.xml", "flappybird");
        popFileSavePath = Application.persistentDataPath + string.Format("/{0}.pop.xml", "flappybird");       
